...
Test::REST::Integrate - Return stored posts as raw responses
...
Feed back previously posted data to the client
 ...
 use HTTP::Response;
 use HTTP::Headers;
 my $r = HTTP::Response->parse(Test::REST::Integrate->new( directory => '/aaa/', request => HTTP::Request->new(POST => '/set', {}, '404 NOT FOUND\nSpecial: DEFG\n\nABCD')));
 my $token = $r->headers->header('Token');
 my $rr = HTTP::Response->parse(Test::REST::Integrate->new( directory => '/aaa/', request => HTTP::Request->new(GET => '/'.$token)));
...
Please report any bugs or feature requests to C<bug-test-rest-integrate at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Test-REST-Integrate>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Test-REST-Integrate>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Test-REST-Integrate>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Test-REST-Integrate>

=item * Search CPAN

L<http://search.cpan.org/dist/Test-REST-Integrate/>
